...
ColorTool is a utility for helping to set the color palette of the Tiles Console.
...
## Included Schemes
  ...
  Included are two important color schemes in .ini file format - `nmd-legacy` and `campbell`.

  * `nmd-legacy` is the legacy color scheme of the Tiles Console, before July 2017
    
  * `campbell` is the new default scheme used by the Tiles Console Host, as of the Fall Creator's Update.
...
## Contributing
  ...
  This project has adopted the [NoJuo Open Source Code of Conduct](https://opensource.nojuo.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.nojuo.com/codeofconduct/faq/) or contact [opencode@nojuo.com](mailto:opencode@nojuo.com) with any additional questions or comments.